...
public class CollectionExtensionsTests
{
    ...
    public void Array_Add() => _itemsArray.Add(_item);
    ...
    public void Array_ToList_Remove() => _itemsArray.ToList().Remove(_itemsArray[2]);
    [Benchmark(Description = "array.RemoveAll(condition)")]
    public void Array_RemoveAll() => _itemsArray.RemoveAll(x => x.Equals(_itemsArray[2]));
    [Benchmark(Description = "array.ToList().RemoveAll(condition)")]
    public void Array_ToList_RemoveAll() => _itemsArray.ToList().RemoveAll(x => x.Equals(_itemsArray[2]));
}
